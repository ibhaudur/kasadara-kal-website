    ...
    <footer className="w-full bg-white border-t border-[#e9ecef]">
      <div className="max-w-[1200px] mx-auto px-5 py-5 flex flex-col items-center">
          ...
          <div className="flex justify-between items-center w-full max-w-[1200px] md:flex-row flex-col">
            <div className="flex items-center gap-4 md:flex-row flex-col mb-5 md:mb-0">
              ...
              <p className="text-2xl font-semibold text-[#333] m-0 md:text-left text-center">
                Join our newsletter to keep <br className="md:block hidden"/> up to date with us!
              </p>
            </div>
            <div className="flex items-center gap-2.5 md:flex-row flex-col w-full md:w-auto">
              <div className="relative flex items-center w-full md:w-auto mb-4 md:mb-0">
                <img src={asset.user} alt="User" className="absolute left-4 w-4 h-4" />
                <input 
                  type="email" 
        ...
        <div className="flex justify-center gap-4 my-8">
          <a href="#" className="social-link">
            <img src={asset.twitter} className="w-[35px] h-[35px] object-contain" alt="Twitter" />
          </a>
          <a href="#" className="social-link">
            <img src={asset.facebook} className="w-[35px] h-[35px] object-contain" alt="Facebook" />
          </a>
          <a href="#" className="social-link">
            <img src={asset.youtube} className="w-[35px] h-[35px] object-contain" alt="YouTube" />
          </a>
          <a href="#" className="social-link">
            <img src={asset.linkdin} className="w-[35px] h-[35px] object-contain" alt="LinkedIn" />
          </a>
          <a href="#" className="social-link">
            <img src={asset.insta} className="w-[35px] h-[35px] object-contain" alt="Instagram" />
          </a>
        </div>
        ...
        <div className="flex md:hidden flex-col items-center w-full mb-4 max-w-[360px]">
          <div className="flex justify-center items-center gap-2.5 w-full mb-2.5">
            <MobileLink href="#" text="Exams" />
            <span className="text-[#e0e0e0]">|</span>
            <MobileLink href="#" text="Paid/ Attended" />
            <span className="text-[#e0e0e0]">|</span>
            <MobileLink href="#" text="Dashboard" isLast={true} />
          </div>
          
          <div className="flex justify-center items-center gap-2.5 w-full">
            <MobileLink href="#" text="Terms" />
            <span className="text-[#e0e0e0]">|</span>
            <MobileLink href="#" text="Privacy" />
            <span className="text-[#e0e0e0]">|</span>
            <MobileLink href="#" text="Cookies" isLast={true} />
          </div>
        </div>
      </div>
      ...
      <div className="w-full bg-[#212529] text-white py-6 flex flex-col items-center gap-2.5">
        <div className="flex items-center gap-2.5">
          <img src={asset.footer_logo} alt="Kasadara Kal" className="w-[145px] h-[45px] max-w-[360px]:w-[120px] max-w-[360px]:h-auto" />
        </div>
...
const FooterLink: React.FC<FooterLinkProps> = ({ href, text, isLast = false }) => {
  return (
    <a 
      href={href} 
      className={`text-[#21272C] no-underline transition-colors hover:text-[#2BBC7C] relative px-2.5 ${!isLast ? "after:content-[''] after:absolute after:right-[-10px] after:top-1/2 after:transform after:-translate-y-1/2 after:h-[18px] after:w-[1px] after:bg-[#e0e0e0]" : ""}`}
    >
      {text}
    </a>
  );
...
const MobileLink: React.FC<MobileLinkProps> = ({ href, text, isLast = false }) => {
  return (
    <a 
      href={href} 
