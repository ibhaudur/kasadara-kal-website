...
const StandOut: React.FC = () => {
  return (
    <div className="relative bg-white rounded-2xl p-5 px-6 shadow-md overflow-hidden mt-5">
      ...
      <div className="grid grid-cols-8 md:grid-cols-8 lg:grid-cols-5 mt-5 gap-5">
        {StandsOutList.map((item, index) => (
          <div
            key={index}
            className="p-3 flex gap-3 col-span-4 md:col-span-2 lg:col-span-1 items-center bg-[#DFFFF1] rounded-2xl"
          >
