  ...
  return (
    <div className="w-full max-w-[1280px] mx-auto  font-['Segoe_UI',sans-serif] mt-5">
      ...
      <div className="border border-[#e0e0e0] rounded-xl overflow-hidden shadow-[0_1px_3px_rgba(0,0,0,0.05)]">
        ...
        <div className="flex p-[16px_20px] relative after:content-[''] after:absolute after:bottom-0 after:left-5 after:right-5 after:h-[1px] after:bg-[#e0e0e0]">
        ...
        <div className="flex p-[16px_20px] relative">
