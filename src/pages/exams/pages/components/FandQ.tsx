...
const FandQ: React.FC = () => {
  ...
  return (
    <div className="w-full max-w-[1280px] mx-auto  font-['Segoe_UI',sans-serif] mt-5 flex">
      <div className="flex-1 max-w-[65%]">
        <h2 className=" font-zoho text-2xl font-bold leading-[100%] tracking-[-0.03em] text-[#333] mb-[30px]">
      ...
      <div className="flex-1 max-w-[30%] flex flex-col items-center border border-[#e0e0e0] rounded-3xl p-5 bg-white shadow-[0_2px_4px_rgba(0,0,0,0.05)] h-fit self-start mt-[50px] ml-15">
        ...
        <div className="text-center">
          <p className="text-[#555] text-[15px] leading-[22px] font-normal mb-5">
            Your success in government exams starts here. Access expert-designed
            mock tests, instant results, and detailed performance analysis all
            in one powerful platform built for your journey.
          </p>
          <a
