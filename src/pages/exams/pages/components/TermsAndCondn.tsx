...
const TermsAndCond: React.FC = () => {
  return (
    <div className="w-[100%] max-w-[1280px] mx-auto  font-['Segoe_UI',Arial,sans-serif] text-[#333] leading-none mt-5 ">
      <h1 className="text-[28px] font-bold leading-[22px] mb-5 text-[#333]">Terms & Conditions</h1>
      
      <div className="terms-content">
        <h2 className="text-lg font-medium mb-5">General Instructions</h2>
        
        <div className="mb-6">
          <h3 className="text-base font-bold mb-2.5 leading-[31px]">1. Time Management:-</h3>
          <p className="mb-2.5 text-base font-normal">
            The timer on the screen will automatically count down the time left for your test. Once the timer reaches zero, your test will auto-submit.
            You do not need to manually end the test.
          </p>
        </div>
        
        <div className="mb-6">
          <h3 className="text-base font-bold mb-2.5 leading-[31px]">2. Question Status Indicators:-</h3>
          <p className="mb-2.5 text-base font-normal">
            The Question Palette will display the status of each question using the following symbols:
          </p>
          <ul className="list-none pl-0 mb-4 text-[#8790A1]">
            <li className="flex items-center mb-2">
              ...
              <span className="text-sm">Answered - You have answered the question.</span>
            </li>
            <li className="flex items-center mb-2">
              <span className="inline-block w-4 h-4 rounded-full mr-2.5 bg-[#F44336]"></span>
              <span className="text-sm">Not answered - You have seen the question but not answered it.</span>
            </li>
            <li className="flex items-center mb-2">
              <span className="inline-block w-4 h-4 rounded-full mr-2.5 bg-[#FF9800]"></span>
              <span className="text-sm">Currently attending - You are actively working on this question.</span>
            </li>
            <li className="flex items-center mb-2">
              <span className="inline-block w-4 h-4 rounded-full mr-2.5 border border-[#ccc] bg-transparent"></span>
              <span className="text-sm">Not attempted yet - You haven't opened or answered this question yet.</span>
            </li>
          </ul>
          ...
          <div className="bg-[#FFF8E6] border border-[#FFE082] rounded-xl px-5 py-3 my-4 flex items-start">
            <span className="text-lg mr-2.5 text-[#21272C]">ⓘ</span>
              ...
              Once you answer a question and click Save & Next, your answer will be locked and cannot be changed later. Please review your selection carefully before clicking Save & Next.
            </p>
          </div>
        </div>
        
        <div className="mb-6">
          <h3 className="text-base font-bold mb-2.5 leading-[31px]">3. Navigation Instructions:</h3>
          <ul className="list-none pl-0 mb-4 text-[#8790A1]">
            {[
              ...
              <li key={index} className="relative pl-4 mb-2 text-sm before:content-['•'] before:absolute before:left-0 before:text-[#666]">
                {item}
              </li>
            ))}
          </ul>
        ...
        <div className="mb-6">
          <h3 className="text-base font-bold mb-2.5 leading-[31px]">4. Answering a Question:-</h3>
          <p className="mb-2.5 text-base font-normal">Procedure for answering a multiple-choice (MCQ) type question:</p>
          <ul className="list-none pl-0 mb-4 text-[#8790A1]">
            {[
